...
interface TemplateState
{
     ...
     *
     * @return string Описание состояния.
     */
     ...
     *
     * @return bool true если пользователю разрешено заполнять по этому шаблону.
     */
    public function canBeUsedForFill(): bool;

    /**
     * Можно ли сделать шаблон активным в текущем состоянии.
     *
     * @return bool true если шаблон можно активировать.
     */
